...
WP_CLI_COMMAND_ARGS: List[str] = ["plugin", "list", "--format=json"]

def main() -> None:
    """
    Demonstrates creating and monitoring a bulk 'run-wp-cli-command' task using
    the dedicated `tasks.create_wp_cli()` method.
    """
    ...
    try:
        ...
        task_request: TaskCreationResponse = client.tasks.create_wp_cli(
